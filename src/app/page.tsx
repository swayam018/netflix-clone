    ...
    <main>
      <div className="bg-[url('https://assets.nflxext.com/ffe/siteui/vlv3/b4c7f092-0488-48b7-854d-ca055a84fb4f/5b22968d-b94f-44ec-bea3-45dcf457f29e/IN-en-20231204-popsignuptwoweeks-perspective_alpha_website_medium.jpg')]">
        ...
        <div className="flex bg-slate-950 bg-opacity-70 pt-56 pb-40 items-center justify-center max-sm:pt-19 max-md:pt-28 max-sm:pb-20">
          <div className="flex flex-col w-8/12 justify-center item-center gap-5 max-lg:w-10/12">
            ...
            <span className=" text-2xl text-slate-50 font-bold text-center max-sm:text-xl">
      ...
      <div className=" w-10/12 pt-8 pb-10 m-auto flex flex-row justify-center items-center gap-10 max-lg:flex-col max-xl:w-full ">
        <div className="flex flex-col justify-center w-5/12 gap-10 max-lg:w-11/12 max-lg:items-center ">
          <span className="text-5xl font-bold max-lg:text-center max-sm:text-4xl">
            Enjoy on your TV
          </span>
          <span className="text-2xl max-lg:text-center max-sm:text-xl">
        ...
        <div className="relative overflow-hidden">
          <div className="relative overflow-hidden">
            ...
            <video
              ...
              loop
              muted
              className="absolute inset-0 z-0 right-0"
            >
              <source
      ...
      <div className=" w-11/12 pt-8 pb-8 m-auto flex flex-row justify-center items-center gap-10 max-lg:flex-col max-xl:w-full max-md:gap-0 max-lg:gap-0 max-[517px]:m-0 ">
        <div className="relative overflow-hidden">
          ...
          <div className=" w-fit h-24 flex flex-row gap-5 bg-black border-2 border-hrbar-400 rounded-lg p-2 relative bottom-28 left-24 z-50  max-[517px]:bottom-20 max-[517px]:left-28 max-[491px]:left-28 max-[459px]:gap-4 max-[517px]:h-17 max-[468px]:left-24 max-[416px]:left-20  max-[389px]:left-17 max-[362px]:left-12 max-[460px]:bottom-16">
            <Image
              ...
              width={56}
              height={40}
              className=" max-[517px]:w-11"
            />
            <div className="flex flex-col gap-1 justify-center ">
              <span className=" font-bold max-[459px]:text-sm">
                Stranger Things
              </span>
              <span className=" text-blue-700 max-[459px]:text-sm">
                Downloading....
              </span>
            </div>
        ...
        <div className="flex flex-col justify-center w-5/12 gap-10 max-lg:w-11/12 max-lg:items-center ">
          <span className="text-5xl font-bold max-lg:text-center max-sm:text-4xl leading-normal">
